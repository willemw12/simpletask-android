...
Only the [Cloudless version](#cloudless-version) is supported and mainly only core features are supported.
...
The [text](#Simpletask) below is based on the original text.
...
Simpletask is translated using weblate: <a href="#"><img alt="Translation status"/></a>

## Cloudless Version

<a href="#"><img src="https://f-droid.org/badge/get-it-on.png" alt="Get it on F-Droid" height="80"/></a>
...
The Dropbox version is not available from F-Droid.
